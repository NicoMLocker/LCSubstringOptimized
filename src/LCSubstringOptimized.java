...
public class LCSubstringOptimized {
    ...
    public static void main(String[] args) {
        ...
        runFullExperiment("LCSubstringOptimizedRand-Exp1.txt");
        System.out.println("Running second full experiment...");
        runFullExperiment("LCSubstringOptimizedRand-Exp2.txt");
        System.out.println("Running third full experiment...");
        runFullExperiment("LCSubstringOptimizedRand-Exp3.txt");
    }
    ...
    public static void verifyWorks(){
        ...
        LCSubstringOptimized.search(a4,b4);

        System.out.println("\n------- Test Run 5 -----");
        String a5 = "AAAAAYYYYYNNNNNEEEEE";
        String b5 = "IIIIIBBBBBEEEEEAAAAA";
        LCSubstringOptimized.search(a5,b5);
    }
    ...
    public static void runFullExperiment(String resultsFileName) {
        ...
        for (int inputSize = 100; inputSize < MAXINPUTSIZE; inputSize = inputSize + 100) {
            ...
            LCSubstringOptimized.search(a,b);
    ...
    public static LCSubstringOptimized search(String str1, String str2){
        ...
        return new LCSubstringOptimized(result, result.length());
    }

    // constructor
    public LCSubstringOptimized(String result, int length) {
        this.result = result;
        this.length = length;
    }
